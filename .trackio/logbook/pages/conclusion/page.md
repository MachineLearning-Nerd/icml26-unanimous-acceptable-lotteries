...
---
<!-- trackio-cell
{"type": "markdown", "id": "cell_0cc9cdaf1081", "created_at": "2026-07-29T12:24:11+00:00", "title": "FULL_GATE_READY", "pinned": true, "pinned_at": "2026-07-29T12:24:12+00:00"}
-->
## Outcome

All five source-anchored membership-query claims pass the fail-closed local gate.

## Scope & cost

| | This reproduction | Full replication |
| --- | --- | --- |
| Scope | Exact finite algorithms and controls | Universal source proofs |
| Hardware | Local CPU | No experimental hardware |
| Cost | $0 | $0 reported |
| Outcome | Five claims exercised | Public proof retains asymptotic scope |
...
---
<!-- trackio-cell
{"type": "code", "id": "cell_9494c8c65d17", "created_at": "2026-07-29T12:24:18+00:00", "title": "Five-claim verification and gate", "command": ["python3", "repro/src/verify.py"], "exit_code": 0, "duration_s": 4.842}
-->
````bash
...
---
<!-- trackio-cell
{"type": "code", "id": "cell_b5d5c21a84f5", "created_at": "2026-07-29T12:24:19+00:00", "title": "Fail-closed publication gate", "command": ["python3", "repro/src/publication_gate.py"], "exit_code": 0, "duration_s": 0.033}
-->
````bash
