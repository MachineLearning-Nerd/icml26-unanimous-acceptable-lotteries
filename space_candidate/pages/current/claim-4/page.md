...
- [Claim contract](https://huggingface.co/spaces/DineshAI/daiccpXZfU/blob/main/evidence/claim-4/claim_contract.json), [source audit](https://huggingface.co/spaces/DineshAI/daiccpXZfU/blob/main/evidence/claim-4/source_audit.md), [method](https://huggingface.co/spaces/DineshAI/daiccpXZfU/blob/main/evidence/claim-4/method.md), [full evaluator record](https://huggingface.co/spaces/DineshAI/daiccpXZfU/blob/main/evidence/claim-4/EVAL.md)
