...
- [Claim contract](https://huggingface.co/spaces/DineshAI/daiccpXZfU/blob/main/evidence/claim-1/claim_contract.json), [source audit](https://huggingface.co/spaces/DineshAI/daiccpXZfU/blob/main/evidence/claim-1/source_audit.md), [method](https://huggingface.co/spaces/DineshAI/daiccpXZfU/blob/main/evidence/claim-1/method.md), [full evaluator record](https://huggingface.co/spaces/DineshAI/daiccpXZfU/blob/main/evidence/claim-1/EVAL.md)
