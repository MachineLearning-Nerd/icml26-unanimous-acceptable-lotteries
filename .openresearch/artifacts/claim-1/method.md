...
Four independently selected sweeps isolate a calibrated quadratic-verification regime and independent variation in `n`, `m`, and `1/epsilon`. The verifier records verification and hyperplane-learning queries separately and compares them only afterward with the exact finite envelope.
